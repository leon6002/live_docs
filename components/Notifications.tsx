...
const Notifications = () => {
    const { inboxNotificaitons } = useInboxNotifications();
    ...
    <Popover>
        ...
        <PopoverContent>
            ...
            <InboxNotificationList>
                ...
                {unreadNotifications.length > 0 && unreadNotifications.map((notificaiton) => (
                    <InboxNotification
                        key={notificaiton.id}
                        inboxNotification={notificaiton}
                        className="bg-dark-200 text-white"
                        href={`/documents/${notificaiton.roomId}`}
                        showActions={false}
                        kinds={{
                            thread: (props) => (
